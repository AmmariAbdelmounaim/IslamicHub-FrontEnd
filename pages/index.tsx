  ...
  return (
    <div className=" bg-primary-orange-light">
      <Reveal>
        <div
          className={`flex ${
            !isMobile && "p-[100px] gap-[125px] justify-between items-center"
          }`}
        >
          <div className="py-[32px] pl-[20px] flex flex-col gap-[32px] pr-[42px]  sm:gap-[64px] sm:p-0">
            ...
            <p className="capitalize text-primary-orange-dark-hover font-poppins text-[18px] sm:text-[20px] sm:font-semibold">
              Start with a warm greeting, Start with a warm greeting Start with
              a warm greeting
            </p>
      ...
      <Reveal>
        <div className="flex flex-col items-center mt-[32px] py-[48px] px-[20px] bg-secondary-brown-light-active sm:py-[64px] sm:px-[203px]">
          ...
          <p className="font-poppins text-justify font-medium text-[16px] text-primary-orange-dark-active capitalize sm:text-[18px]">
            ...
            revolutionize the way Islamic Centers manage their online presence.
            Instead of the lengthy and expensive process of setting up
            individual websites, IslamicHub offers a unique, central platform
            for these institutions to generate and share their content.
          </p>
        </div>
      </Reveal>
          ...
          <Reveal>
            <div className=" sm:px-[105px]">
              ...
              <p className="font-poppins text-center font-medium text-[16px] text-secondary-brown-darker capitalize sm:text-[18px]">
                Showcase the diverse range of services, programs, and activities
                offered by the Islamic center.Showcase the diverse range of
                services, programs, and activities offered by the Islamic
                center.
              </p>
            </div>
          </Reveal>
