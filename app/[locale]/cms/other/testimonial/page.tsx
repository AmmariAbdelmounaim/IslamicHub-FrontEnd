...
import { Slide, Testimonial } from "../../../../../types/types";
import { useState } from "react";
import { useAppDispatch, useAppSelector } from "../../../../../redux/store";
import Test from "../../../preview/Testimonials";
...
} from "../../../../../redux/features/testimonialApiSlice";
import {
  removeTestmonial,
  setTestmonial,
  updateTestmonial,
...
function TestimonialSection() {
  ...
  const initialValues: FormValues = {
    testimonials: (userInfo?.centerDTO.homePageDTO
      .testimonialDTOList as Testimonial[]) ?? [
      {
        image: [],
        userName: "",
        comment: "",
        ...
        <div className="flex flex-col gap-[40px]">
          <div className="flex flex-col gap-[24px]">
            ...
            <p className="font-poppins text-primary-orange-dark-active text-[18px] capitalize">
              in this section include testimonials from volunteers in your
              center.
            </p>
          </div>
          <div className="flex flex-col gap-[24px]">
            ...
            <Formik
              ...
              onSubmit={async (values) => {
                try {
                  ...
                  for (const testimonial of values.testimonials) {
                    console.log("testimonial haha: ", testimonial);
                    const testimonialRes = await editTestimonial({
                      id: testimonial.id,
                    ...
                    console.log(testimonialRes);
                    if ("data" in testimonialRes) {
                      dispatch(updateTestmonial({ ...testimonialRes.data }));
                    }
                    // Optional: log the response for each event if you need
                    console.log("testimonial response: ", { testimonialRes });
                  }
                      ...
                      render={(arrayHelpers) => (
                        <div className="flex flex-col gap-[40px] items-center">
                          {(userInfo?.centerDTO.homePageDTO.testimonialDTOList
                            .length as number) > 0 &&
                            userInfo?.centerDTO.homePageDTO.testimonialDTOList.map(
                          ...
                          <FillButton
                            ...
                            type="button"
                            onClick={async () => {
                              const testimonialRes = await createTestimonial({
                                id: 0,
                                image: null,
                                username: "",
                                comment: "",
                              ...
                              dispatch(setTestmonial({ ...testimonialRes }));

                              arrayHelpers.push(testimonialRes);
