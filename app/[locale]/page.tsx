          ...
          <div className=" bg-primary-orange-light">
            ...
            <Reveal>
              <div className="flex sm:p-[100px] sm:gap-[125px] sm:justify-between sm:items-center">
                <div className="py-[32px] pl-[20px]  flex flex-col gap-[32px] pr-[42px] w-[1000px]  sm:gap-[64px] sm:p-0">
                  <div>
                  ...
                  <FillButton
                    additionalStyle="capitalize py-[16px] px-[40px] w-[280px] h-[50px] flex items-center justify-center"
                    onClick={() => {
