...
export default function GetInTouch() {
  return (
    <div
      className="
      flex flex-col items-center justify-center mb-[60px] "
    >
      <h1 className="text-[40px] font-sourceSerif font-normal text-primary-orange-darker mb-4">
        Get In Touch
      </h1>
      <div
        className="
...
"
        >
          <label
            htmlFor="name"
            className="block text-[18px] font-normal font-poppins text-secondary-brown-dark"
          >
            Your name
          </label>
          <input
